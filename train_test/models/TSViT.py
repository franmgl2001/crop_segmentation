...
from patch_embeddings import StandardPatchEmbedding
...
if __name__ == "__main__":
    ...
    print(channels)
    model = TSViT(img_res=res, num_channels=channels, model_config=model_config, num_classes=num_classes, patch_embedding="Channel Encoding")
